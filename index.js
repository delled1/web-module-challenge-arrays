...
const notOriginalFlavors = ["red", "blue", "green", "orange"];
...
console.log(is31Flavors(notOriginalFlavors.length));
...
// var found = originalFlavors[6].includes("Chocolate");
// console.log(found);
...
function getRandomFlavors(a, b, c, d) {
  let randomFlavors = [];
  let totalFlavors = [...a, ...b, ...c, ...d];
  for (let i = 0; i < 31; i++) {
    randomFlavors.push(totalFlavors[Math.floor(Math.random() * [i])]);
  }
